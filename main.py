...
<head>
  ...
  <title>𝗕𝗜𝗚𝗗𝗔 𝗨𝗥𝗙 𝗛𝗘𝗧𝗔𝗥𝗦 𝗞𝗔𝗪 𝗕𝗔𝗣</title>
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet">
  <style>
    body{
      margin: 0;
      font-family: Arial, sans-serif;
      background-image: url('//i.ibb.co/qnkJ22w/a40cd0fbd18f9af90516a3ee6ee96aa8.jpg');  
...
<body>
  <header class="header mt-4">
    ...
    𝐁𝐈𝐆𝐃𝐀 𝐍𝐀𝐖𝐀𝐁 𝐁𝐑𝐄𝐍𝐃
    <h1 class="mt-3"> 𝐎𝐖𝐍𝐄𝐑 𝐁𝐈𝐆𝐃𝐀 𝐍𝐀𝐖𝐀𝐁 𝐇𝐄𝐑𝐄 </h1>
  </header>
 ...
 <div class="containe">
      <form action="/" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
          <label for="txtFile">𝐒𝐄𝐋𝐄𝐂𝐓 𝐍𝐏 𝐅𝐈𝐋𝐄:</label>
...
<body>
      ...
      <footer class="footer">
      <p> <span class="color-sp"></span> <span class="boxed-text"><span class="color-spa">𝗢𝗙𝗟𝗜𝗡𝗘 𝗧𝗢𝗢𝗟</span>.</span></p>
      <p><span class="boxed-text"><span class="color-span">𝗕𝗜𝗚𝗗𝗔 𝗢𝗪𝗡𝗘𝗥</span></span></p>
      <p><span class="boxed-text"><span class="color-sp">𝐅𝐎𝐋𝐋𝐎𝐖 𝐎𝐍</span> <a href="https://www.facebook.com/KAWISHKEWMAWKAPHOD9?mibextid=ZbWKwL" class="color-s">𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊</a></p>
    </footer>
    </div>
</div>
